...
class ConvertDateUtilityTest extends TestCase
{
    ...
    public static function dataProviderConvertDateAndBackWithConvertFromDateTimeToCalendarAndConvertFromCalendarToDateTime()
    {
        $result = [];
        foreach ([
            'de_DE' => 'Europe/Berlin',
            ...
            foreach ([
                ...
                $result[] = [
                    'In the first step the UTC-testdate `' . $calendarResult['utcDateTime'] . '` of the ' .
    ...
    public static function dataProviderConvertFromDateTimeToCalendarGivenDateTimeConvertedToEstimatedFormat()
    {
        ...
        foreach ([
            ...
            'QQQ' => 'Q3',
            'QQQQ' => '3rd quarter',
            'QQQQQ' => '3', // narrow quarter form yields the numeric value (ICU/CLDR), not the wide '3rd quarter'
            'q' => '3',
            'qq' => '03',
            'qqq' => 'Q3',
            'qqqq' => '3rd quarter',
            'qqqqq' => '3', // narrow standalone quarter form yields the numeric value (ICU/CLDR), not the wide '3rd quarter'
            'M' => '9',
            'MM' => '09',
            'MMM' => 'Sept', // en abbreviated September is 'Sept' since CLDR 42 / ICU 72
            'MMMM' => 'September',
            'MMMMM' => 'S',
            'L' => '9',
            'LL' => '09',
            'LLL' => 'Sept', // en standalone abbreviated September is 'Sept' since CLDR 42 / ICU 72
            'LLLL' => 'September',
            'LLLLL' => 'S',
            'w' => '36',
            'ww' => '36',
            ...
            $result[] = [
                'The date `' . $helpDate->format('d.m.Y H:i:s') . '` is converted with the ICU.' .
