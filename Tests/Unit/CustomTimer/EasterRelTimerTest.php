...
class EasterRelTimerTest extends TestCase
{
    ...
    public function dataProviderValidateGeneralByVariationArgumentsInParam()
    {
        ...
        $result = [];
        $result[] = [
            'message' => 'The validation will be okay. It`s a randomly selected test-case.',
            'expects' => [
                'result' => true,
            ],
            'params' => [
...
//        // Variation for useTimeZoneOfFrontend
    ...
    public function dataProviderValidateSpeciallByVariationArgumentsInParam()
    {
        ...
        foreach (['easter','ascension','pentecost','firstadvent','christmas','rosemonday','goodfriday','towlday',] as $dateIdentifier) {
            /* test allowed minimal structure */
            $result[] = [
        ...
        foreach ([null, '', -475200, -10000, -1000, '-100', -10, -2, -1, 0, '0', 1, 2, 10, 100, 100000, '475200'] as $DateNumber) {
            /* test allowed minimal structure */
            $result[] = [
...
//        ];
    ...
    public function dataProviderNextActive()
    {
        ...
        $mapName = [0 => 'easter', 1 => 'ascending', 2 => 'pentecost', 3 => '1. Advent', 4 => 'christmas', 5 => 'rose mondey', 6 => 'good friday'];
        foreach (
            [
                'easter' => ['1400-01-18 11:00:00' => '1400-04-18', '1584-04-19 11:00:00' => '1584-04-19',
                    '1752-03-29 12:00:00' => '1753-04-22', '1754-04-14 13:00:00' => '1755-03-30',
                    '2020-04-12 14:00:00' => '2021-04-04', '2050-04-10 18:00:00' => '2051-04-02',], // easter
                'ascension' => ['1400-01-27 11:00:00' => '1400-05-27', '1584-05-28 11:00:00' => '1584-05-28',
                    '1752-05-07 12:00:00' => '1753-05-31', '1754-05-23 13:00:00' => '1755-05-08',
                    '2020-05-21 14:00:00' => '2021-05-13', '2050-05-19 18:00:00' => '2051-05-11',], // ascending
                'pentecost' => ['1400-01-06 11:00:00' => '1400-06-06', '1584-06-07 11:00:00' => '1584-06-07',
                    '1752-05-17 12:00:00' => '1753-06-10', '1754-06-02 13:00:00' => '1755-05-18',
                    '2020-05-31 14:00:00' => '2021-05-23', '2050-05-29 18:00:00' => '2051-05-21',], // pentecost
                'firstadvent' => ['1400-01-25 11:00:00' => '1400-11-30', '1584-12-02 11:00:00' => '1584-12-02',
                    '1752-12-03 12:00:00' => '1753-12-02', '1754-12-01 13:00:00' => '1755-11-30',
                    '2020-11-29 14:00:00' => '2021-11-28', '2050-11-27 18:00:00' => '2051-12-03',], // 1. advent
                'christmas' => ['1400-03-25 11:00:00' => '1400-12-25', '1584-12-25 11:00:00' => '1584-12-25',
                    '1752-12-25 12:00:00' => '1753-12-25', '1754-12-25 13:00:00' => '1755-12-25',
                    '2020-12-25 14:00:00' => '2021-12-25', '2050-12-25 18:00:00' => '2051-12-25',], // Christmas
                'rosemonday' => ['1400-01-01 11:00:00' => '1400-03-01', '1584-03-02 11:00:00' => '1584-03-02',
                    '1752-02-10 12:00:00' => '1753-03-05', '1754-02-25 13:00:00' => '1755-02-10',
                    '2020-02-24 14:00:00' => '2021-02-15', '2050-02-21 18:00:00' => '2051-02-13',], // rose monday
                'goodfriday' => ['1400-01-16 11:00:00' => '1400-04-16', '1584-04-17 11:00:00' => '1584-04-17',
                    '1752-03-27 12:00:00' => '1753-04-20', '1754-04-12 13:00:00' => '1755-03-28',
                    '2020-04-12 14:00:00' => '2021-04-02', '2050-04-08 18:00:00' => '2051-03-31',], // good friday
            ] as $namedDate => $list
        ) {
        ...
        // Variation of duration and relToMin
        $myMapName = [0 => 'easter', 1 => 'ascending', 2 => 'pentecost', 3 => '1. Advent', 4 => 'christmas', 5 => 'rose mondey', 6 => 'good friday'];
        ...
        foreach ([
                     '0' => ['easter' => '1400-04-18', 'ascension' => '1582-05-24', 'pentecost' => '1583-05-19', 'firstadvent' => '1752-11-29', 'christmas' => '1752-12-25', 'rosemonday' => '1752-02-10', 'goodfriday' => '2020-04-10'],
                     '1' => ['easter' => '1400-04-18', 'ascension' => '1582-05-24', 'pentecost' => '1583-05-29', 'firstadvent' => '1752-12-03', 'christmas' => '1752-12-25', 'rosemonday' => '1752-02-11', 'goodfriday' => '2020-04-10'],
                     '2' => ['easter' => '1400-04-20', 'ascension' => '1582-05-27', 'pentecost' => '1583-05-29', 'firstadvent' => '1752-12-03', 'christmas' => '1752-12-25', 'rosemonday' => '1752-02-11', 'goodfriday' => '2020-04-10'],
                     '3' => ['easter' => '1400-04-18', 'ascension' => '1582-05-24', 'pentecost' => '1583-05-19', 'firstadvent' => '1752-11-29', 'christmas' => '1752-12-25', 'rosemonday' => '1752-02-10', 'goodfriday' => '2020-04-04'],
        ...
        // 4. The variation of Variate third Parameter `ultimateBeginningTimer` and `ultimateEndingTimer`
        foreach (['0001-01-01 00:00:00', '2020-12-25 11:00:00', '2020-12-25 13:00:00', '2020-12-25 18:00:00', '9999-12-31 23:59:59',] as $timeString) {
            $result[] = [
    ...
    public function dataProviderPrevActive()
    {
        ...
        // Variation for starte time and Datetype
        /// Easterday cal by https://www.nvf.ch/ostern.asp
        $mapName = ['easter' => 'easter', 'ascension' => 'ascending', 'pentecost' => 'pentecost', 'firstadvent' => '1. Advent', 'christmas' => 'christmas', 'rosemonday' => 'rose mondey', 'goodfriday' => 'good friday'];
        foreach (
            [
                'easter' => ['1400-10-18 15:00:00' => '1400-04-18', '1584-04-19 15:00:00' => '1584-04-19',
                    '1753-04-22 12:00:00' => '1752-03-29', '1755-03-30 13:00:00' => '1754-04-14',
                    '2021-04-04 14:00:00' => '2020-04-12', '2051-04-02 11:00:00' => '2050-04-10',], // easter
                'ascension' => ['1400-10-27 11:00:00' => '1400-05-27', '1584-05-28 15:00:00' => '1584-05-28',
                    '1753-05-31 12:00:00' => '1752-05-07', '1755-05-08 13:00:00' => '1754-05-23',
                    '2021-05-13 14:00:00' => '2020-05-21', '2051-05-11 11:00:00' => '2050-05-19',], // ascending
                'pentecost' => ['1400-10-06 11:00:00' => '1400-06-06', '1584-06-07 15:00:00' => '1584-06-07',
                    '1753-06-10 12:00:00' => '1752-05-17', '1755-05-18 13:00:00' => '1754-06-02',
                    '2021-05-23 14:00:00' => '2020-05-31', '2051-05-21 11:00:00' => '2050-05-29',], // pentecost
                'firstadvent' => ['1400-12-25 11:00:00' => '1400-11-30', '1584-12-02 15:00:00' => '1584-12-02',
                    '1753-12-02 12:00:00' => '1752-12-03', '1755-11-30 13:00:00' => '1754-12-01',
                    '2021-11-28 14:00:00' => '2020-11-29', '2051-12-03 11:00:00' => '2050-11-27',], // 1. advent
                'christmas' => ['1400-12-31 11:00:00' => '1400-12-25', '1584-12-25 18:00:00' => '1584-12-25',
                    '1753-12-25 12:00:00' => '1752-12-25', '1755-12-25 13:00:00' => '1754-12-25',
                    '2021-12-25 14:00:00' => '2020-12-25', '2051-12-25 11:00:00' => '2050-12-25',], // Christmas
                'rosemonday' => ['1400-04-01 11:00:00' => '1400-03-01', '1584-03-02 15:00:00' => '1584-03-02',
                    '1753-03-05 12:00:00' => '1752-02-10', '1755-02-10 13:00:00' => '1754-02-25',
                    '2021-02-15 14:00:00' => '2020-02-24', '2051-02-13 03:00:00' => '2050-02-21',], // rose monday
                'goodfriday' => ['1400-05-16 11:00:00' => '1400-04-16', '1584-04-17 15:00:00' => '1584-04-17',
                    '1753-04-20 12:00:00' => '1752-03-27', '1755-03-28 13:00:00' => '1754-04-12',
                    '2021-04-02 14:00:00' => '2020-04-12', '2051-03-31 18:00:00' => '2050-04-08',], // good friday
            ] as $namedDate => $list
        ) {
            foreach ($list as $testDate => $expectDate) {
                $result[] = [
        ...
        // Methode 3 easter ever julian calendar
        foreach ([
                     '0' => ['easter' => '1400-04-18', 'ascension' => '1582-05-24', 'pentecost' => '1583-05-19',
                         'firstadvent' => '1752-11-29', 'christmas' => '1752-12-25', 'rosemonday' => '1752-02-10',
                         'goodfriday' => '2020-04-10'],
                     '1' => ['easter' => '1400-04-18', 'ascension' => '1582-05-24', 'pentecost' => '1583-05-29',
                         'firstadvent' => '1752-12-03', 'christmas' => '1752-12-25', 'rosemonday' => '1752-02-11',
                         'goodfriday' => '2020-04-10'],
                     '2' => ['easter' => '1400-04-20', 'ascension' => '1582-05-27', 'pentecost' => '1583-05-29',
                      'firstadvent' => '1752-12-03', 'christmas' => '1752-12-25', 'rosemonday' => '1752-02-11',
                         'goodfriday' => '2020-04-10'],
                     '3' => ['easter' => '1400-04-18', 'ascension' => '1582-05-24', 'pentecost' => '1583-05-19',
                      'firstadvent' => '1752-11-29', 'christmas' => '1752-12-25', 'rosemonday' => '1752-02-10',
                      'goodfriday' => '2020-04-04'],
                     'null' => ['easter' => '1400-04-18', 'ascension' => '1582-05-24', 'pentecost' => '1583-05-19',
                      'firstadvent' => '1752-11-29', 'christmas' => '1752-12-25', 'rosemonday' => '1752-02-10',
                         'goodfriday' => '2020-04-10'],
                 ] as $method => $list) {
            foreach ($list as $dateKey => $dateString) {
    ...
    ////// bug in PHP or misunderstanding by me
    ////// the dateTime makes some trouble while calculating the summertime
