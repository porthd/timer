...
class HolidayCalendarListTimerTest extends TestCase
{
...
//        $myCacheInstance->getCache(TimerConst::CACHE_IDENT_TIMER_YAMLLIST);
    ...
    {
        $rest = [
            'yamlPeriodFilePath' => '/..' . substr(realpath(__DIR__ . '/../../../../timer/Resources/Public/Yaml/Example_PeriodListTimer.yaml'),
                    strlen('var/www/html/',)),
            'yamlPeriodFalRelation' => '0',
        ];
        $optional = [
            'calendarJsFilePath' => '/..' . substr(realpath(__DIR__ . '/../../../../timer/Resources/Public/Javascript/caleandar-master/js/caleandar.js'),
                    strlen('var/www/html/',)),
            'customCalendarJsFilePath' => '/..' . substr(realpath(__DIR__ . '/../../../../timer/Resources/Public/Javascript/CustomCalendar.js'),
                    strlen('var/www/html/',)),
            'calendarCssFilePath' => '/..' . substr(realpath(__DIR__ . '/../../../../timer/Resources/Public/Javascript/caleandar-master/css/theme1.css'),
                    strlen('var/www/html/',)),
            'customCalendarCssFilePath' => '/..' . substr(realpath(__DIR__ . '/../../../../timer/Resources/Public/Javascript/CustomCalendar.css'),
                    strlen('var/www/html/',)),
        ];
        $result = [];
...
//            zone: 'Europe/Berlin'
        ...
        foreach ([
                     [
                         ...
                         'begin' => '2022-07-14 00:00:00',
                         'end' => '2022-08-24 23:59:59',
                     ],
                     [
                         'date' => '2022-07-14 00:00:00',
                         'begin' => '2022-10-17 00:00:00',
                     ...
                     [
                         'date' => '2022-10-16 23:59:59',
                         'begin' => '2022-10-17 00:00:00',
                         'end' => '2022-10-28 23:59:59',
                     ],
                     [
                         'date' => '2022-10-17 00:00:00',
                         'begin' => '2022-12-23 00:00:00',
                         'end' => '2023-01-06 23:59:59',
                     ],
                     [
