...
class MoonphaseRelTimerTest extends TestCase
{
    ...
    public static function dataProviderValidateSpeciallByVariationArgumentsInParam()
    {
        ...
        foreach ([
            ...
            /* test allowed minimal structure */
            $result[] = [
                'The test for moonphase with `' . $moonphase .
    ...
    public static function dataProviderIsActive()
    {
        ...
        foreach ([
            ...
            //    Ereignis lokal = 2050-06-07 09:53:59 UTC + durationMinutes 120
            //    Aktivfenster (UTC) = [09:53:59, 11:53:59].
            // HINWEIS: Das aktuelle tzdata projiziert die Sommerzeit (Europe/Berlin,
            // GMT+2) bis 2050. Das Aktivfenster liegt daher lokal bei [11:54, 13:53].
            // Ein aelterer Kommentar vermutete hier faelschlich, PHP wende 2050 keine
            // Sommerzeit mehr an (Fenster [10:54, 12:53]); diese Erwartung war
            // tzdata-abhaengig und wurde um +60 min korrigiert. Bleibt fragil, falls
            // kuenftige tzdata-Versionen die 2050er DST-Regel aendern.
            '2050-06-07 10:50:00' => false,
            '2050-06-07 11:50:00' => false,
            '2050-06-07 11:53:00' => false,
            '2050-06-07 11:54:00' => true,
            '2050-06-07 11:55:00' => true,
            '2050-06-07 11:57:00' => true,
            '2050-06-07 12:00:00' => true,
            '2050-06-07 12:10:00' => true,
            '2050-06-07 12:20:00' => true,
            '2050-06-07 12:30:00' => true,
            '2050-06-07 12:50:00' => true,
            '2050-06-07 12:51:00' => true,
            '2050-06-07 13:49:00' => true,
            '2050-06-07 13:53:00' => true,
            '2050-06-07 13:54:00' => false,
            '2050-06-07 14:00:00' => false,
            ...
            $result[] = [
                'The date-time  `' . $dateString . '` ' . (($flagResult) ? 'must be' : 'must not be') . ' active.',
                'expects' => [
                    'result' => $flagResult,
                ],
                'params' => [
        ...
        foreach (['2075-12-24 09:50:00', '2075-12-24 09:51:00'] as $dateString) {
            $result[] = [
                'The date-time  `' . $dateString . '` must never be active, baecause the timegamp is zero (0)r.',
                'expects' => [
                    'result' => false,
                ],
                'params' => [
        ...
        foreach ([
            ...
            foreach ($timeList as $key => $dateString) {
                ...
                $result[] = [
                    'The date-time  `' . $dateString . '` ' . (($flagResult) ? 'must be' : 'must not be') . ' active by variation of timegap',
                    'expects' => [
                        'result' => $flagResult,
                    ],
                    'params' => [
        ...
        foreach ([
            ...
            foreach ($timeList as $key => $dateString) {
                $flagResult = (!in_array($key, [0, 3]));
                $result[] = [
                    'The date-time  `' . $dateString . '` ' . (($flagResult) ? 'must be' : 'must not be') .
    ...
    public static function dataProviderNextActive()
    {
        ...
        $result[] = [
            'The nextRange in this example is correctly detected, because the active Time ist part of an active range. ',
            'expects' => [
                'result' => [
    ...
    public static function dataProviderPrevActive()
    {
        ...
        //                     '2022-06-16 13:53:00' => true,
        $result[] = [
            'The prevRange in this example is correctly detected, because the startdate ist part of the an active range. ',
            'expects' => [
                'result' => [
                    'beginning' => '2022-06-16 13:52:00',
                    'ending' => '2022-06-16 15:53:00',
        ...
        $result[] = [
            'The prevRange in this example is correctly detected, because the startdate is one minute higher than the previous active range',
            'expects' => [
                'result' => [
                    'beginning' => '2022-07-15 20:38:00',
                    // fullmoon calculated by algorithm : 13. Juli 2022, 20.37 instead of   13. Juli 2022, 20:37
